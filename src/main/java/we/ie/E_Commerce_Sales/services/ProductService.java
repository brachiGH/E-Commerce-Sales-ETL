...
public interface ProductService {
    ...
    List<ReviewDTO> getReviews(Long productId) throws ProductNotFoundException;
    ...
    ReviewDTO addReview(Long productId, Long clientId, Short review) throws ProductNotFoundException, ClientNotFoundException;
}
